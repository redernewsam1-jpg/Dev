...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8659544140:AAG0J5WDRnSVGHeWa13ckC7HKpEYeYOg4Vg")

CREDIT = os.environ.get("CREDIT", "⌯ FʀᴏɴᴛMᴀɴ | ×͜× |")
# MongoDB Configuration
DATABASE_NAME = os.environ.get("DATABASE_NAME", "DevThanos")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://omh87299_db_user:9oNnVAlCFuciez93@cluster0.pgcg7ql.mongodb.net/?appName=Cluster0")  # Add your own atlas db
MONGO_URL = DATABASE_URL  # For auth system

# Owner and Admin Configuration
OWNER_ID = int(os.environ.get("OWNER_ID", "1403488629"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "1403488629").split()]  # Default to owner ID
